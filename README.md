...
Самый безопасный вариант для клиента:

```text
1. Купить USB 3.0 флешку 32 GB.
2. Не форматировать ее самостоятельно.
3. Вставить флешку в Keenetic.
4. Дать мастеру доступ к роутеру.
5. Мастер форматирует флешку через веб-интерфейс Keenetic или prepare-usb.sh.
```
...
```text
Нужен Keenetic Hopper/Hero/Giga и USB 3.0 флешка 32 GB.
Флешку заранее не форматируйте, мы подготовим ее под Entware.
```
